...
/**
	...
	Settings
		...
		Here's the list of replicated input events that are sent to each of the abilities. This project uses multiple for each attack pattern
...
// namespace EAbilityGenericReplicatedEvent
	...
	{	
		...
		GameCustom1, // PrimaryAttack
		GameCustom2, // SecondaryAttack
		GameCustom3, // SpecialAttack
		GameCustom4, // StrongAttack
		GameCustom5,
		GameCustom6,
		MAX
	};
