...
// Primary values
#define Curve_Hand_Lock_L FName("Hand_Lock_L")
#define Curve_Hand_Lock_R FName("Hand_Lock_R")
#define Curve_Foot_Lock_L FName("Foot_Lock_L")
#define Curve_Foot_Lock_R FName("Foot_Lock_R")
#define Curve_Foot_Incline_L FName("Foot_Incline_L")
#define Curve_Foot_Incline_R FName("Foot_Incline_R")
