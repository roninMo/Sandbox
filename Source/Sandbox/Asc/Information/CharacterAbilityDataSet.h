...
/** DataAsset that can be used to define an enemies stats, equipment, and abilities */
UCLASS(BlueprintType)
class SANDBOX_API UEnemyAbilityDataSet : public UPrimaryDataAsset
{
	GENERATED_BODY()

public:
	UEnemyAbilityDataSet() = default;
