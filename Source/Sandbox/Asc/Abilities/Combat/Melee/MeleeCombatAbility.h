...
/**
 * Melee combat needs to be refactored to handle attack logic on both the server and the client. With unreal's replication system using gameplay abilities, client side prediction makes things easier
