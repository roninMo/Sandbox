...
#include "Save_Level.generated.h"

/**
 * 
 */
UCLASS()
class SANDBOX_API USave_Level : public USaveLogic
{
	GENERATED_BODY()
...
public:
	...
	/*
		...
		Save Logic specific to level
		-> Event function reference to save level information within it's blueprint
